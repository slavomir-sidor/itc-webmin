...
/**
 *  RepositoryStatusListItem bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RepositoryStatusListItem implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = repository-status-list-item
       Namespace URI =
       Namespace Prefix =
     */
     ...
     * field for Status
     */
    protected sk.itcloud.nexus.RepositoryStatus localStatus;
    ...
    /**
     * Auto generated getter method
     * @return sk.itcloud.nexus.RepositoryStatus
     */
    public sk.itcloud.nexus.RepositoryStatus getStatus() {
        return localStatus;
    }
     ...
     * @param param Status
     */
    public void setStatus(sk.itcloud.nexus.RepositoryStatus param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":repository-status-list-item", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
         ...
         */
        public static RepositoryStatusListItem parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RepositoryStatusListItem object = new RepositoryStatusListItem();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"repository-status-list-item".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RepositoryStatusListItem) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "status").equals(
                            reader.getName())) {
                    object.setStatus(sk.itcloud.nexus.RepositoryStatus.Factory.parse(
                            reader));

...
/**
 *  RepositoryGroupResource bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RepositoryGroupResource extends sk.itcloud.nexus.BaseRepository
    implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = repository-group-resource
       Namespace URI =
       Namespace Prefix =
     */
     ...
     */
    protected sk.itcloud.nexus.Repositories_type0 localRepositories;
     ...
     * @return sk.itcloud.nexus.Repositories_type0
     */
    public sk.itcloud.nexus.Repositories_type0 getRepositories() {
     ...
     */
    public void setRepositories(sk.itcloud.nexus.Repositories_type0 param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":repository-group-resource",
                xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "repository-group-resource", xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static RepositoryGroupResource parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RepositoryGroupResource object = new RepositoryGroupResource();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"repository-group-resource".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RepositoryGroupResource) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "repositories").equals(
                            reader.getName())) {
                    object.setRepositories(sk.itcloud.nexus.Repositories_type0.Factory.parse(
                            reader));

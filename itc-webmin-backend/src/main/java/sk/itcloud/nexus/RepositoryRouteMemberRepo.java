/**
 * RepositoryRouteMemberRepo.java
 *
...
/**
 *  RepositoryRouteMemberRepo bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RepositoryRouteMemberRepo implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = repository-route-member-repo
       Namespace URI =
       Namespace Prefix =
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":repository-route-member-repo", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "repository-route-member-repo", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RepositoryRouteMemberRepo parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RepositoryRouteMemberRepo object = new RepositoryRouteMemberRepo();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"repository-route-member-repo".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RepositoryRouteMemberRepo) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

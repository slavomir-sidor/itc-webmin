...
/**
 *  ClientPermission bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ClientPermission implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":clientPermission", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "clientPermission", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ClientPermission parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ClientPermission object = new ClientPermission();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"clientPermission".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ClientPermission) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

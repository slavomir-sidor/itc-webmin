...
/**
 *  Groups_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Groups_type0 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":groups_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "groups_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Groups_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Groups_type0 object = new Groups_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"groups_type0".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Groups_type0) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("", "string").equals(
                                        reader.getName())) {
                                list1.add(reader.getElementText());
                            } else {
                                loopDone1 = true;

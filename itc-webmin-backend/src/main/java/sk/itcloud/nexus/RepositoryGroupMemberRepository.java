/**
 * RepositoryGroupMemberRepository.java
 *
...
/**
 *  RepositoryGroupMemberRepository bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RepositoryGroupMemberRepository implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = repository-group-member-repository
       Namespace URI =
       Namespace Prefix =
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":repository-group-member-repository",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "repository-group-member-repository", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RepositoryGroupMemberRepository parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RepositoryGroupMemberRepository object = new RepositoryGroupMemberRepository();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"repository-group-member-repository".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RepositoryGroupMemberRepository) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

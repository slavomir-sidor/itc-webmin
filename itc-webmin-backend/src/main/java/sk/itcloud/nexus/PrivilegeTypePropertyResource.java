/**
 * PrivilegeTypePropertyResource.java
 *
...
/**
 *  PrivilegeTypePropertyResource bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class PrivilegeTypePropertyResource implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = privilegeTypePropertyResource
       Namespace URI =
       Namespace Prefix =
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":privilegeTypePropertyResource",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "privilegeTypePropertyResource", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static PrivilegeTypePropertyResource parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PrivilegeTypePropertyResource object = new PrivilegeTypePropertyResource();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"privilegeTypePropertyResource".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (PrivilegeTypePropertyResource) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

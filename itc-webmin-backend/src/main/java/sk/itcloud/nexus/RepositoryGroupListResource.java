/**
 * RepositoryGroupListResource.java
 *
...
/**
 *  RepositoryGroupListResource bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RepositoryGroupListResource implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = repository-group-list-resource
       Namespace URI =
       Namespace Prefix =
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":repository-group-list-resource",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "repository-group-list-resource", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RepositoryGroupListResource parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RepositoryGroupListResource object = new RepositoryGroupListResource();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"repository-group-list-resource".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RepositoryGroupListResource) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

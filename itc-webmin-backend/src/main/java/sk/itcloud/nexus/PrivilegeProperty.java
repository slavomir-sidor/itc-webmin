...
/**
 *  PrivilegeProperty bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class PrivilegeProperty implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = privilegeProperty
       Namespace URI =
       Namespace Prefix =
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":privilegeProperty", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "privilegeProperty", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static PrivilegeProperty parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PrivilegeProperty object = new PrivilegeProperty();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"privilegeProperty".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (PrivilegeProperty) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

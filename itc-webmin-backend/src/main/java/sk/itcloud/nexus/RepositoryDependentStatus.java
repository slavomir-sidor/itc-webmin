/**
 * RepositoryDependentStatus.java
 *
...
/**
 *  RepositoryDependentStatus bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RepositoryDependentStatus implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = repository-dependent-status
       Namespace URI =
       Namespace Prefix =
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":repository-dependent-status", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "repository-dependent-status", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RepositoryDependentStatus parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RepositoryDependentStatus object = new RepositoryDependentStatus();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"repository-dependent-status".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RepositoryDependentStatus) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

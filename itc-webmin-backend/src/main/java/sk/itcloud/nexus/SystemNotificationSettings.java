/**
 * SystemNotificationSettings.java
 *
...
/**
 *  SystemNotificationSettings bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SystemNotificationSettings implements org.apache.axis2.databinding.ADBBean {
    ...
    public void addRoles(java.lang.String param) {
        ...
        list.add(param);
        this.localRoles = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":system-notification-settings", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "system-notification-settings", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SystemNotificationSettings parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SystemNotificationSettings object = new SystemNotificationSettings();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"system-notification-settings".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SystemNotificationSettings) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("", "roles").equals(
                                        reader.getName())) {
                                list1.add(reader.getElementText());
                            } else {
                                loopDone1 = true;
                    ...
                    object.setRoles((java.lang.String[]) list1.toArray(
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "emailAddresses").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "emailAddresses").equals(
                            reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "emailAddresses" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setEmailAddresses(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));

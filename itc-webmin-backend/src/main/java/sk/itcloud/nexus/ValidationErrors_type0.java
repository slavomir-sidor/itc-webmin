...
/**
 *  ValidationErrors_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ValidationErrors_type0 implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = validationErrors_type0
       Namespace URI =
       Namespace Prefix =
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":validationErrors_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "validationErrors_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ValidationErrors_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ValidationErrors_type0 object = new ValidationErrors_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"validationErrors_type0".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ValidationErrors_type0) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("", "error").equals(
                                        reader.getName())) {
                                list1.add(reader.getElementText());
                            } else {
                                loopDone1 = true;
                    ...
                    object.setError((java.lang.String[]) list1.toArray(

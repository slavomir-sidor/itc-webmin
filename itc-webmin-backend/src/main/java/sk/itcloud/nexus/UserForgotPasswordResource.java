/**
 * UserForgotPasswordResource.java
 *
...
/**
 *  UserForgotPasswordResource bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class UserForgotPasswordResource implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = userForgotPasswordResource
       Namespace URI =
       Namespace Prefix =
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":userForgotPasswordResource", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "userForgotPasswordResource", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static UserForgotPasswordResource parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UserForgotPasswordResource object = new UserForgotPasswordResource();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"userForgotPasswordResource".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (UserForgotPasswordResource) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

...
/**
 *  Roles_type3 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Roles_type3 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":roles_type3", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "roles_type3", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Roles_type3 parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Roles_type3 object = new Roles_type3();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"roles_type3".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Roles_type3) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

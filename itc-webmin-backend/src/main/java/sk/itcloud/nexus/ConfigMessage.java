...
/**
 *  ConfigMessage bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ConfigMessage implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":configMessage", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "configMessage", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ConfigMessage parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ConfigMessage object = new ConfigMessage();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"configMessage".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ConfigMessage) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

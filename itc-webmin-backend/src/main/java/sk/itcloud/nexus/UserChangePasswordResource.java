/**
 * UserChangePasswordResource.java
 *
...
/**
 *  UserChangePasswordResource bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class UserChangePasswordResource implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = userChangePasswordResource
       Namespace URI =
       Namespace Prefix =
     */
    ...
    public void setOldPassword(java.lang.String param) {
        localOldPasswordTracker = param != null;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":userChangePasswordResource", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "userChangePasswordResource", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static UserChangePasswordResource parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UserChangePasswordResource object = new UserChangePasswordResource();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"userChangePasswordResource".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (UserChangePasswordResource) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "oldPassword").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "oldPassword").equals(
                            reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "oldPassword" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setOldPassword(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "newPassword").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "newPassword").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",

/**
 * ScheduledServicePropertyResource.java
 *
...
/**
 *  ScheduledServicePropertyResource bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ScheduledServicePropertyResource implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = scheduled-service-property-resource
       Namespace URI =
       Namespace Prefix =
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":scheduled-service-property-resource",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "scheduled-service-property-resource", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ScheduledServicePropertyResource parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ScheduledServicePropertyResource object = new ScheduledServicePropertyResource();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"scheduled-service-property-resource".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ScheduledServicePropertyResource) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

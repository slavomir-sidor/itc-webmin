/**
 * RepositoryRouteListResource.java
 *
...
/**
 *  RepositoryRouteListResource bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RepositoryRouteListResource implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = repository-route-list-resource
       Namespace URI =
       Namespace Prefix =
     */
     ...
     */
    protected sk.itcloud.nexus.Repositories_type2 localRepositories;
    ...
    /**
     * Auto generated getter method
     * @return sk.itcloud.nexus.Repositories_type2
     */
    public sk.itcloud.nexus.Repositories_type2 getRepositories() {
     ...
     */
    public void setRepositories(sk.itcloud.nexus.Repositories_type2 param) {
    ...
    public void setRuleType(java.lang.String param) {
        localRuleTypeTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":repository-route-list-resource",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "repository-route-list-resource", xmlWriter);
            }
        }
        ...
        if (localRuleTypeTracker) {
            ...
            if (localRuleType == null) {
                ...
                xmlWriter.writeCharacters(localRuleType);
            }
    ...
    public static class Factory {
         ...
         */
        public static RepositoryRouteListResource parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RepositoryRouteListResource object = new RepositoryRouteListResource();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"repository-route-list-resource".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RepositoryRouteListResource) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "pattern").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "pattern").equals(
                            reader.getName())) {
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "repositories").equals(
                            reader.getName())) {
                    object.setRepositories(sk.itcloud.nexus.Repositories_type2.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "ruleType").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "ruleType").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "ruleType" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setRuleType(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));

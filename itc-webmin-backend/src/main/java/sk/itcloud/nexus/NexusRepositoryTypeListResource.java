/**
 * NexusRepositoryTypeListResource.java
 *
...
/**
 *  NexusRepositoryTypeListResource bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class NexusRepositoryTypeListResource implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = nexus-repository-type-list-resource
       Namespace URI =
       Namespace Prefix =
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":nexus-repository-type-list-resource",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "nexus-repository-type-list-resource", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static NexusRepositoryTypeListResource parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            NexusRepositoryTypeListResource object = new NexusRepositoryTypeListResource();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"nexus-repository-type-list-resource".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (NexusRepositoryTypeListResource) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

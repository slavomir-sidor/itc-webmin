...
/**
 *  RepositoryRouteResource bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RepositoryRouteResource implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = repository-route-resource
       Namespace URI =
       Namespace Prefix =
     */
     ...
     */
    protected sk.itcloud.nexus.Repositories_type1 localRepositories;
    ...
    /**
     * Auto generated getter method
     * @return sk.itcloud.nexus.Repositories_type1
     */
    public sk.itcloud.nexus.Repositories_type1 getRepositories() {
     ...
     */
    public void setRepositories(sk.itcloud.nexus.Repositories_type1 param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":repository-route-resource", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "repository-route-resource", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RepositoryRouteResource parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RepositoryRouteResource object = new RepositoryRouteResource();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"repository-route-resource".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RepositoryRouteResource) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "repositories").equals(
                            reader.getName())) {
                    object.setRepositories(sk.itcloud.nexus.Repositories_type1.Factory.parse(
                            reader));

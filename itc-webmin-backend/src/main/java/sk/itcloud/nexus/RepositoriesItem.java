...
/**
 *  RepositoriesItem bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RepositoriesItem implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = repositories-item
       Namespace URI =
       Namespace Prefix =
     */
    ...
    /**
     * field for UserManaged
     */
    protected boolean localUserManaged;
    ...
    /**
     * field for RepoPolicy
     */
    protected java.lang.String localRepoPolicy;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localRepoPolicyTracker = false;
     ...
     * field for RemoteUri
     */
    protected java.lang.String localRemoteUri;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localRemoteUriTracker = false;

    /**
     * field for EffectiveLocalStorageUrl
     */
    protected java.lang.String localEffectiveLocalStorageUrl;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localEffectiveLocalStorageUrlTracker = false;
    ...
    public boolean getUserManaged() {
        return localUserManaged;
    }

    /**
     * Auto generated setter method
     * @param param UserManaged
     */
    public void setUserManaged(boolean param) {
        this.localUserManaged = param;
    }
    ...
    public boolean isRepoPolicySpecified() {
        return localRepoPolicyTracker;
    }
    ...
    public java.lang.String getRepoPolicy() {
        return localRepoPolicy;
    }

    /**
     * Auto generated setter method
     * @param param RepoPolicy
     */
    public void setRepoPolicy(java.lang.String param) {
        localRepoPolicyTracker = param != null;

        this.localRepoPolicy = param;
    }
    ...
    public boolean isRemoteUriSpecified() {
        return localRemoteUriTracker;
    }
    ...
    public java.lang.String getRemoteUri() {
        return localRemoteUri;
    }

    /**
     * Auto generated setter method
     * @param param RemoteUri
     */
    public void setRemoteUri(java.lang.String param) {
        localRemoteUriTracker = param != null;

        this.localRemoteUri = param;
    }

    public boolean isEffectiveLocalStorageUrlSpecified() {
        return localEffectiveLocalStorageUrlTracker;
    }
    ...
    public java.lang.String getEffectiveLocalStorageUrl() {
        return localEffectiveLocalStorageUrl;
    }

    /**
     * Auto generated setter method
     * @param param EffectiveLocalStorageUrl
     */
    public void setEffectiveLocalStorageUrl(java.lang.String param) {
        localEffectiveLocalStorageUrlTracker = param != null;

        this.localEffectiveLocalStorageUrl = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":repositories-item", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "repositories-item", xmlWriter);
            }
        }
        ...
        namespace = "";
        writeStartElement(null, namespace, "userManaged", xmlWriter);

        if (false) {
            throw new org.apache.axis2.databinding.ADBException(
                "userManaged cannot be null!!");
        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localUserManaged));
        }
        ...
        if (localRepoPolicyTracker) {
            namespace = "";
            writeStartElement(null, namespace, "repoPolicy", xmlWriter);

            if (localRepoPolicy == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "repoPolicy cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localRepoPolicy);
            }
        ...
        if (localRemoteUriTracker) {
            namespace = "";
            writeStartElement(null, namespace, "remoteUri", xmlWriter);

            if (localRemoteUri == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "remoteUri cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localRemoteUri);
            }

            xmlWriter.writeEndElement();
        }

        if (localEffectiveLocalStorageUrlTracker) {
            namespace = "";
            writeStartElement(null, namespace, "effectiveLocalStorageUrl",
                xmlWriter);

            if (localEffectiveLocalStorageUrl == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "effectiveLocalStorageUrl cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localEffectiveLocalStorageUrl);
            }
    ...
    public static class Factory {
         ...
         */
        public static RepositoriesItem parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RepositoriesItem object = new RepositoriesItem();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"repositories-item".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RepositoriesItem) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "userManaged").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "userManaged").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "userManaged" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setUserManaged(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                            content));
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "repoPolicy").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "repoPolicy").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "repoPolicy" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setRepoPolicy(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "remoteUri").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "remoteUri").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "remoteUri" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setRemoteUri(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("",
                            "effectiveLocalStorageUrl").equals(reader.getName())) ||
                        new javax.xml.namespace.QName("",
                            "effectiveLocalStorageUrl").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "effectiveLocalStorageUrl" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setEffectiveLocalStorageUrl(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));

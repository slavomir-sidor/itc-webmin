...
/**
 *  MirrorResource bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class MirrorResource implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":mirror-resource", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "mirror-resource", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static MirrorResource parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            MirrorResource object = new MirrorResource();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"mirror-resource".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (MirrorResource) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

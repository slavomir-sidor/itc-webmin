...
/**
 *  PlexusUserResource bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class PlexusUserResource implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = plexusUserResource
       Namespace URI =
       Namespace Prefix =
     */
     ...
     * field for Roles
     */
    protected sk.itcloud.nexus.Roles_type2 localRoles;
    ...
    /**
     * Auto generated getter method
     * @return sk.itcloud.nexus.Roles_type2
     */
    public sk.itcloud.nexus.Roles_type2 getRoles() {
        return localRoles;
    }
     ...
     * @param param Roles
     */
    public void setRoles(sk.itcloud.nexus.Roles_type2 param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":plexusUserResource", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "plexusUserResource", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static PlexusUserResource parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PlexusUserResource object = new PlexusUserResource();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"plexusUserResource".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (PlexusUserResource) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "roles").equals(
                            reader.getName())) {
                    object.setRoles(sk.itcloud.nexus.Roles_type2.Factory.parse(
                            reader));

...
public class UserAccount implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":userAccount", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "userAccount", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static UserAccount parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"userAccount".equals(type)) {
                            ...
                            return (UserAccount) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

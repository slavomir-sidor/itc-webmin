...
/**
 *  UserToRoleResource bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class UserToRoleResource implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = userToRoleResource
       Namespace URI =
       Namespace Prefix =
     */
     ...
     * field for Roles
     */
    protected sk.itcloud.nexus.Roles_type1 localRoles;
    ...
    /**
     * Auto generated getter method
     * @return sk.itcloud.nexus.Roles_type1
     */
    public sk.itcloud.nexus.Roles_type1 getRoles() {
        return localRoles;
    }
     ...
     * @param param Roles
     */
    public void setRoles(sk.itcloud.nexus.Roles_type1 param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":userToRoleResource", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "userToRoleResource", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static UserToRoleResource parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UserToRoleResource object = new UserToRoleResource();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"userToRoleResource".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (UserToRoleResource) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "roles").equals(
                            reader.getName())) {
                    object.setRoles(sk.itcloud.nexus.Roles_type1.Factory.parse(
                            reader));

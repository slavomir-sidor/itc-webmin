...
/**
 *  PrivilegeStatusResource bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class PrivilegeStatusResource implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = privilegeStatusResource
       Namespace URI =
       Namespace Prefix =
     */
     ...
     */
    protected sk.itcloud.nexus.Properties_type1 localProperties;
     ...
     * @return sk.itcloud.nexus.Properties_type1
     */
    public sk.itcloud.nexus.Properties_type1 getProperties() {
     ...
     */
    public void setProperties(sk.itcloud.nexus.Properties_type1 param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":privilegeStatusResource", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "privilegeStatusResource", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static PrivilegeStatusResource parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PrivilegeStatusResource object = new PrivilegeStatusResource();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"privilegeStatusResource".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (PrivilegeStatusResource) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "properties").equals(
                            reader.getName())) {
                    object.setProperties(sk.itcloud.nexus.Properties_type1.Factory.parse(
                            reader));

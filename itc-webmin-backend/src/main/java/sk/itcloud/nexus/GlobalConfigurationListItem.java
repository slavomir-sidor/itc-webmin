/**
 * GlobalConfigurationListItem.java
 *
...
/**
 *  GlobalConfigurationListItem bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GlobalConfigurationListItem implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = global-configuration-list-item
       Namespace URI =
       Namespace Prefix =
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":global-configuration-list-item",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "global-configuration-list-item", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GlobalConfigurationListItem parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GlobalConfigurationListItem object = new GlobalConfigurationListItem();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"global-configuration-list-item".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GlobalConfigurationListItem) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

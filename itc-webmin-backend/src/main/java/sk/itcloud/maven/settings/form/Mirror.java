...
public class Mirror implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for MirrorOf
     */
    protected java.lang.String localMirrorOf;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localMirrorOfTracker = false;
    ...
    public boolean isMirrorOfSpecified() {
        return localMirrorOfTracker;
    }
    ...
    public java.lang.String getMirrorOf() {
        return localMirrorOf;
    }

    /**
     * Auto generated setter method
     * @param param MirrorOf
     */
    public void setMirrorOf(java.lang.String param) {
        localMirrorOfTracker = param != null;

        this.localMirrorOf = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Mirror", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Mirror", xmlWriter);
        ...
        if (localMirrorOfTracker) {
            namespace = "http://maven.apache.org/SETTINGS/1.0.0";
            writeStartElement(null, namespace, "mirrorOf", xmlWriter);

            if (localMirrorOf == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "mirrorOf cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localMirrorOf);
            }
    ...
    public static class Factory {
         ...
         */
        public static Mirror parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Mirror object = new Mirror();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Mirror".equals(type)) {
                            ...
                            return (Mirror) sk.itcloud.maven.settings.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "http://maven.apache.org/SETTINGS/1.0.0",
                                    "mirrorOf").equals(reader.getName())) ||
                                new javax.xml.namespace.QName("", "mirrorOf").equals(
                                    reader.getName())) {
                            ...
                            if ("true".equals(nillableValue) ||
                                ...
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "mirrorOf" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setMirrorOf(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));

...
public class Profile implements org.apache.axis2.databinding.ADBBean {
     ...
     * @return org.apache.maven.settings._1_0_0.Activation
     */
    public sk.itcloud.maven.settings.form.Activation getActivation() {
     ...
     */
    public void setActivation(sk.itcloud.maven.settings.form.Activation param) {
    ...
    /**
     * Auto generated getter method
     * @return org.apache.maven.settings._1_0_0.Properties_type0
     */
    public sk.itcloud.maven.settings.form.Properties_type0 getProperties() {
    ...
    public void setProperties(
        sk.itcloud.maven.settings.form.Properties_type0 param) {
    ...
    /**
     * Auto generated getter method
     * @return org.apache.maven.settings._1_0_0.Repositories_type0
     */
    public sk.itcloud.maven.settings.form.Repositories_type0 getRepositories() {
    ...
    public void setRepositories(
        sk.itcloud.maven.settings.form.Repositories_type0 param) {
    ...
    /**
     * Auto generated getter method
     * @return org.apache.maven.settings._1_0_0.PluginRepositories_type0
     */
    public sk.itcloud.maven.settings.form.PluginRepositories_type0 getPluginRepositories() {
    ...
    public void setPluginRepositories(
        sk.itcloud.maven.settings.form.PluginRepositories_type0 param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localActivationTracker) {
            ...
            localActivation.serialize(new javax.xml.namespace.QName(
                    "http://maven.apache.org/SETTINGS/1.0.0", "activation"),
                xmlWriter);
        }
        ...
        if (localPropertiesTracker) {
            ...
            localProperties.serialize(new javax.xml.namespace.QName(
                    "http://maven.apache.org/SETTINGS/1.0.0", "properties"),
                xmlWriter);
        }
        ...
        if (localRepositoriesTracker) {
            ...
            localRepositories.serialize(new javax.xml.namespace.QName(
                    "http://maven.apache.org/SETTINGS/1.0.0", "repositories"),
                xmlWriter);
        }
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Profile".equals(type)) {
                            ...
                            return (Profile) sk.itcloud.maven.settings.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "activation").equals(
                                    reader.getName())) {
                            object.setActivation(sk.itcloud.maven.settings.form.Activation.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "properties").equals(
                                    reader.getName())) {
                            object.setProperties(sk.itcloud.maven.settings.form.Properties_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "repositories").equals(
                                    reader.getName())) {
                            object.setRepositories(sk.itcloud.maven.settings.form.Repositories_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("",
                                    "pluginRepositories").equals(
                                    reader.getName())) {
                            object.setPluginRepositories(sk.itcloud.maven.settings.form.PluginRepositories_type0.Factory.parse(
                                    reader));

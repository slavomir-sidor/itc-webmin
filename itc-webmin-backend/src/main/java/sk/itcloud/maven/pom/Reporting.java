...
public class Reporting implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Plugins
     */
    protected sk.itcloud.maven.pom.Plugins_type2 localPlugins;
     ...
     */
    public sk.itcloud.maven.pom.Plugins_type2 getPlugins() {
        return localPlugins;
    }
     ...
     * @param param Plugins
     */
    public void setPlugins(sk.itcloud.maven.pom.Plugins_type2 param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Reporting".equals(type)) {
                            ...
                            return (Reporting) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "plugins").equals(
                                    reader.getName())) {
                            object.setPlugins(sk.itcloud.maven.pom.Plugins_type2.Factory.parse(
                                    reader));

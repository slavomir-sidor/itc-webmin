...
public class ReportSet implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Reports
     */
    protected sk.itcloud.maven.pom.Reports_type1 localReports;
     ...
     */
    protected sk.itcloud.maven.pom.Configuration_type3 localConfiguration;
     ...
     */
    public sk.itcloud.maven.pom.Reports_type1 getReports() {
        return localReports;
    }
     ...
     * @param param Reports
     */
    public void setReports(sk.itcloud.maven.pom.Reports_type1 param) {
     ...
     */
    public sk.itcloud.maven.pom.Configuration_type3 getConfiguration() {
    ...
    public void setConfiguration(
        sk.itcloud.maven.pom.Configuration_type3 param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ReportSet".equals(type)) {
                            ...
                            return (ReportSet) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "reports").equals(
                                    reader.getName())) {
                            object.setReports(sk.itcloud.maven.pom.Reports_type1.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("",
                                    "configuration").equals(reader.getName())) {
                            object.setConfiguration(sk.itcloud.maven.pom.Configuration_type3.Factory.parse(
                                    reader));

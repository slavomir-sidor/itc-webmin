...
public class Contributor implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Roles
     */
    protected sk.itcloud.maven.pom.Roles_type1 localRoles;
     ...
     */
    protected sk.itcloud.maven.pom.Properties_type1 localProperties;
     ...
     */
    public sk.itcloud.maven.pom.Roles_type1 getRoles() {
        return localRoles;
    }
     ...
     * @param param Roles
     */
    public void setRoles(sk.itcloud.maven.pom.Roles_type1 param) {
     ...
     */
    public sk.itcloud.maven.pom.Properties_type1 getProperties() {
    ...
    public void setProperties(
        sk.itcloud.maven.pom.Properties_type1 param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Contributor".equals(type)) {
                            ...
                            return (Contributor) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "roles").equals(
                                    reader.getName())) {
                            object.setRoles(sk.itcloud.maven.pom.Roles_type1.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "properties").equals(
                                    reader.getName())) {
                            object.setProperties(sk.itcloud.maven.pom.Properties_type1.Factory.parse(
                                    reader));

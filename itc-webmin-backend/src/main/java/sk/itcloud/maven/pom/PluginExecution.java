...
public class PluginExecution implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Goals
     */
    protected sk.itcloud.maven.pom.Goals_type0 localGoals;
     ...
     */
    protected sk.itcloud.maven.pom.Configuration_type1 localConfiguration;
     ...
     */
    public sk.itcloud.maven.pom.Goals_type0 getGoals() {
        return localGoals;
    }
     ...
     * @param param Goals
     */
    public void setGoals(sk.itcloud.maven.pom.Goals_type0 param) {
     ...
     */
    public sk.itcloud.maven.pom.Configuration_type1 getConfiguration() {
    ...
    public void setConfiguration(
        sk.itcloud.maven.pom.Configuration_type1 param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PluginExecution".equals(type)) {
                            ...
                            return (PluginExecution) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "goals").equals(
                                    reader.getName())) {
                            object.setGoals(sk.itcloud.maven.pom.Goals_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("",
                                    "configuration").equals(reader.getName())) {
                            object.setConfiguration(sk.itcloud.maven.pom.Configuration_type1.Factory.parse(
                                    reader));

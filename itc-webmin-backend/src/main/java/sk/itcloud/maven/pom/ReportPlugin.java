...
public class ReportPlugin implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected sk.itcloud.maven.pom.ReportSets_type0 localReportSets;
     ...
     */
    protected sk.itcloud.maven.pom.Configuration_type4 localConfiguration;
     ...
     */
    public sk.itcloud.maven.pom.ReportSets_type0 getReportSets() {
    ...
    public void setReportSets(
        sk.itcloud.maven.pom.ReportSets_type0 param) {
     ...
     */
    public sk.itcloud.maven.pom.Configuration_type4 getConfiguration() {
    ...
    public void setConfiguration(
        sk.itcloud.maven.pom.Configuration_type4 param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ReportPlugin".equals(type)) {
                            ...
                            return (ReportPlugin) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "reportSets").equals(
                                    reader.getName())) {
                            object.setReportSets(sk.itcloud.maven.pom.ReportSets_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("",
                                    "configuration").equals(reader.getName())) {
                            object.setConfiguration(sk.itcloud.maven.pom.Configuration_type4.Factory.parse(
                                    reader));

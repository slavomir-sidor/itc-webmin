...
public class Plugin implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected sk.itcloud.maven.pom.Executions_type0 localExecutions;
     ...
     */
    protected sk.itcloud.maven.pom.Dependencies_type2 localDependencies;
     ...
     * field for Goals
     */
    protected sk.itcloud.maven.pom.Goals_type1 localGoals;
     ...
     */
    protected sk.itcloud.maven.pom.Configuration_type2 localConfiguration;
     ...
     */
    public sk.itcloud.maven.pom.Executions_type0 getExecutions() {
    ...
    public void setExecutions(
        sk.itcloud.maven.pom.Executions_type0 param) {
     ...
     */
    public sk.itcloud.maven.pom.Dependencies_type2 getDependencies() {
    ...
    public void setDependencies(
        sk.itcloud.maven.pom.Dependencies_type2 param) {
     ...
     */
    public sk.itcloud.maven.pom.Goals_type1 getGoals() {
        return localGoals;
    }
     ...
     * @param param Goals
     */
    public void setGoals(sk.itcloud.maven.pom.Goals_type1 param) {
     ...
     */
    public sk.itcloud.maven.pom.Configuration_type2 getConfiguration() {
    ...
    public void setConfiguration(
        sk.itcloud.maven.pom.Configuration_type2 param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Plugin".equals(type)) {
                            ...
                            return (Plugin) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "executions").equals(
                                    reader.getName())) {
                            object.setExecutions(sk.itcloud.maven.pom.Executions_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "dependencies").equals(
                                    reader.getName())) {
                            object.setDependencies(sk.itcloud.maven.pom.Dependencies_type2.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "goals").equals(
                                    reader.getName())) {
                            object.setGoals(sk.itcloud.maven.pom.Goals_type1.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("",
                                    "configuration").equals(reader.getName())) {
                            object.setConfiguration(sk.itcloud.maven.pom.Configuration_type2.Factory.parse(
                                    reader));

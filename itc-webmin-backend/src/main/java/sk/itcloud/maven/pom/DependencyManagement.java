...
public class DependencyManagement implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected sk.itcloud.maven.pom.Dependencies_type0 localDependencies;
     ...
     */
    public sk.itcloud.maven.pom.Dependencies_type0 getDependencies() {
    ...
    public void setDependencies(
        sk.itcloud.maven.pom.Dependencies_type0 param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DependencyManagement".equals(type)) {
                            ...
                            return (DependencyManagement) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "dependencies").equals(
                                    reader.getName())) {
                            object.setDependencies(sk.itcloud.maven.pom.Dependencies_type0.Factory.parse(
                                    reader));

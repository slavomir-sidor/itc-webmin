...
public class Resource implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Includes
     */
    protected sk.itcloud.maven.pom.Includes_type0 localIncludes;
     ...
     * field for Excludes
     */
    protected sk.itcloud.maven.pom.Excludes_type0 localExcludes;
     ...
     */
    public sk.itcloud.maven.pom.Includes_type0 getIncludes() {
     ...
     */
    public void setIncludes(sk.itcloud.maven.pom.Includes_type0 param) {
     ...
     */
    public sk.itcloud.maven.pom.Excludes_type0 getExcludes() {
     ...
     */
    public void setExcludes(sk.itcloud.maven.pom.Excludes_type0 param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Resource".equals(type)) {
                            ...
                            return (Resource) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "includes").equals(
                                    reader.getName())) {
                            object.setIncludes(sk.itcloud.maven.pom.Includes_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "excludes").equals(
                                    reader.getName())) {
                            object.setExcludes(sk.itcloud.maven.pom.Excludes_type0.Factory.parse(
                                    reader));

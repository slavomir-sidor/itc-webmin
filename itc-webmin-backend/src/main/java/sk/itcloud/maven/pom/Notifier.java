...
public class Notifier implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected sk.itcloud.maven.pom.Configuration_type0 localConfiguration;
     ...
     */
    public sk.itcloud.maven.pom.Configuration_type0 getConfiguration() {
    ...
    public void setConfiguration(
        sk.itcloud.maven.pom.Configuration_type0 param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Notifier".equals(type)) {
                            ...
                            return (Notifier) sk.itcloud.maven.pom.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("",
                                    "configuration").equals(reader.getName())) {
                            object.setConfiguration(sk.itcloud.maven.pom.Configuration_type0.Factory.parse(
                                    reader));

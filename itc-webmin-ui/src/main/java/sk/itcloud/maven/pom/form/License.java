...
public class License implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected java.lang.String localDistribution;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localDistributionTracker = false;
    ...
    public boolean isDistributionSpecified() {
        return localDistributionTracker;
    }
     ...
     */
    public void setDistribution(java.lang.String param) {
        localDistributionTracker = param != null;

        this.localDistribution = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":License", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "License", xmlWriter);
        ...
        if (localDistributionTracker) {
            namespace = "http://maven.apache.org/POM/4.0.0";
            writeStartElement(null, namespace, "distribution", xmlWriter);
            ...
            if (localDistribution == null) {
                ...
                xmlWriter.writeCharacters(localDistribution);
            }
    ...
    public static class Factory {
         ...
         */
        public static License parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            License object = new License();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"License".equals(type)) {
                            ...
                            return (License) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "http://maven.apache.org/POM/4.0.0",
                                    "distribution").equals(reader.getName())) ||
                                new javax.xml.namespace.QName("", "distribution").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            object.setDistribution(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));

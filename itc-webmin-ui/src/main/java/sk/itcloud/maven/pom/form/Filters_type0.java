...
public class Filters_type0 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":filters_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "filters_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Filters_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Filters_type0 object = new Filters_type0();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"filters_type0".equals(type)) {
                            ...
                            return (Filters_type0) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

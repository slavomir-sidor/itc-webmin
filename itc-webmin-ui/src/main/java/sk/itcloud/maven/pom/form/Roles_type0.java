...
/**
 *  Roles_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Roles_type0 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":roles_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "roles_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Roles_type0 parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Roles_type0 object = new Roles_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"roles_type0".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Roles_type0) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

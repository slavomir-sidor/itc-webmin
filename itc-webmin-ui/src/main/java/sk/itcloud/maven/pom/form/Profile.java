...
public class Profile implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected sk.itcloud.maven.pom.form.Activation localActivation;
     ...
     * field for Build
     */
    protected sk.itcloud.maven.pom.form.BuildBase localBuild;
     ...
     * field for Modules
     */
    protected sk.itcloud.maven.pom.form.Modules_type1 localModules;
     ...
     */
    protected sk.itcloud.maven.pom.form.Properties_type3 localProperties;
     ...
     */
    protected sk.itcloud.maven.pom.form.Dependencies_type3 localDependencies;
     ...
     */
    protected sk.itcloud.maven.pom.form.Repositories_type1 localRepositories;
     ...
     */
    protected sk.itcloud.maven.pom.form.PluginRepositories_type1 localPluginRepositories;
     ...
     * field for Reports
     */
    protected sk.itcloud.maven.pom.form.Reports_type2 localReports;
     ...
     */
    public sk.itcloud.maven.pom.form.Activation getActivation() {
     ...
     */
    public void setActivation(sk.itcloud.maven.pom.form.Activation param) {
     ...
     */
    public sk.itcloud.maven.pom.form.BuildBase getBuild() {
        return localBuild;
    }
     ...
     * @param param Build
     */
    public void setBuild(sk.itcloud.maven.pom.form.BuildBase param) {
     ...
     */
    public sk.itcloud.maven.pom.form.Modules_type1 getModules() {
        return localModules;
    }
     ...
     * @param param Modules
     */
    public void setModules(sk.itcloud.maven.pom.form.Modules_type1 param) {
     ...
     */
    public sk.itcloud.maven.pom.form.Properties_type3 getProperties() {
    ...
    public void setProperties(
        sk.itcloud.maven.pom.form.Properties_type3 param) {
     ...
     */
    public sk.itcloud.maven.pom.form.Dependencies_type3 getDependencies() {
    ...
    public void setDependencies(
        sk.itcloud.maven.pom.form.Dependencies_type3 param) {
     ...
     */
    public sk.itcloud.maven.pom.form.Repositories_type1 getRepositories() {
    ...
    public void setRepositories(
        sk.itcloud.maven.pom.form.Repositories_type1 param) {
     ...
     */
    public sk.itcloud.maven.pom.form.PluginRepositories_type1 getPluginRepositories() {
    ...
    public void setPluginRepositories(
        sk.itcloud.maven.pom.form.PluginRepositories_type1 param) {
     ...
     */
    public sk.itcloud.maven.pom.form.Reports_type2 getReports() {
        return localReports;
    }
     ...
     * @param param Reports
     */
    public void setReports(sk.itcloud.maven.pom.form.Reports_type2 param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Profile".equals(type)) {
                            ...
                            return (Profile) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "activation").equals(
                                    reader.getName())) {
                            object.setActivation(sk.itcloud.maven.pom.form.Activation.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "build").equals(
                                    reader.getName())) {
                            object.setBuild(sk.itcloud.maven.pom.form.BuildBase.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "modules").equals(
                                    reader.getName())) {
                            object.setModules(sk.itcloud.maven.pom.form.Modules_type1.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "properties").equals(
                                    reader.getName())) {
                            object.setProperties(sk.itcloud.maven.pom.form.Properties_type3.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "dependencies").equals(
                                    reader.getName())) {
                            object.setDependencies(sk.itcloud.maven.pom.form.Dependencies_type3.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "repositories").equals(
                                    reader.getName())) {
                            object.setRepositories(sk.itcloud.maven.pom.form.Repositories_type1.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("",
                                    "pluginRepositories").equals(
                                    reader.getName())) {
                            object.setPluginRepositories(sk.itcloud.maven.pom.form.PluginRepositories_type1.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "reports").equals(
                                    reader.getName())) {
                            object.setReports(sk.itcloud.maven.pom.form.Reports_type2.Factory.parse(
                                    reader));

...
/**
 *  Reports_type1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Reports_type1 implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected void validateReport(java.lang.String[] param) {
    }
     ...
     */
    public void addReport(java.lang.String param) {
        if (localReport == null) {
            localReport = new java.lang.String[] {  };
        }
        ...
        list.add(param);
        this.localReport = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":reports_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "reports_type1", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Reports_type1 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Reports_type1 object = new Reports_type1();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"reports_type1".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Reports_type1) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://maven.apache.org/POM/4.0.0", "report").equals(
                            reader.getName())) ||
                        new javax.xml.namespace.QName("", "report").equals(
                            reader.getName())) {
                    ...
                    object.setReport((java.lang.String[]) list1.toArray(

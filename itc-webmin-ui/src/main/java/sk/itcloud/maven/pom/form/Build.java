...
public class Build implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected sk.itcloud.maven.pom.form.Extensions_type0 localExtensions;
     ...
     * field for Resources
     */
    protected sk.itcloud.maven.pom.form.Resources_type0 localResources;
     ...
     */
    protected sk.itcloud.maven.pom.form.TestResources_type0 localTestResources;
     ...
     * field for Filters
     */
    protected sk.itcloud.maven.pom.form.Filters_type0 localFilters;
     ...
     */
    protected sk.itcloud.maven.pom.form.PluginManagement localPluginManagement;
     ...
     * field for Plugins
     */
    protected sk.itcloud.maven.pom.form.Plugins_type1 localPlugins;
     ...
     */
    public sk.itcloud.maven.pom.form.Extensions_type0 getExtensions() {
    ...
    public void setExtensions(
        sk.itcloud.maven.pom.form.Extensions_type0 param) {
     ...
     */
    public sk.itcloud.maven.pom.form.Resources_type0 getResources() {
     ...
     */
    public void setResources(sk.itcloud.maven.pom.form.Resources_type0 param) {
     ...
     */
    public sk.itcloud.maven.pom.form.TestResources_type0 getTestResources() {
    ...
    public void setTestResources(
        sk.itcloud.maven.pom.form.TestResources_type0 param) {
     ...
     */
    public sk.itcloud.maven.pom.form.Filters_type0 getFilters() {
        return localFilters;
    }
     ...
     * @param param Filters
     */
    public void setFilters(sk.itcloud.maven.pom.form.Filters_type0 param) {
     ...
     */
    public sk.itcloud.maven.pom.form.PluginManagement getPluginManagement() {
    ...
    public void setPluginManagement(
        sk.itcloud.maven.pom.form.PluginManagement param) {
     ...
     */
    public sk.itcloud.maven.pom.form.Plugins_type1 getPlugins() {
        return localPlugins;
    }
     ...
     * @param param Plugins
     */
    public void setPlugins(sk.itcloud.maven.pom.form.Plugins_type1 param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Build".equals(type)) {
                            ...
                            return (Build) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "extensions").equals(
                                    reader.getName())) {
                            object.setExtensions(sk.itcloud.maven.pom.form.Extensions_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "resources").equals(
                                    reader.getName())) {
                            object.setResources(sk.itcloud.maven.pom.form.Resources_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("",
                                    "testResources").equals(reader.getName())) {
                            object.setTestResources(sk.itcloud.maven.pom.form.TestResources_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "filters").equals(
                                    reader.getName())) {
                            object.setFilters(sk.itcloud.maven.pom.form.Filters_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("",
                                    "pluginManagement").equals(reader.getName())) {
                            object.setPluginManagement(sk.itcloud.maven.pom.form.PluginManagement.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "plugins").equals(
                                    reader.getName())) {
                            object.setPlugins(sk.itcloud.maven.pom.form.Plugins_type1.Factory.parse(
                                    reader));

...
public class Reporting implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * field for ExcludeDefaults
     */
    protected java.lang.String localExcludeDefaults;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localExcludeDefaultsTracker = false;
     ...
     * field for Plugins
     */
    protected sk.itcloud.maven.pom.form.Plugins_type2 localPlugins;
    ...
    public boolean isExcludeDefaultsSpecified() {
        return localExcludeDefaultsTracker;
    }
    ...
    public java.lang.String getExcludeDefaults() {
        return localExcludeDefaults;
    }

    /**
     * Auto generated setter method
     * @param param ExcludeDefaults
     */
    public void setExcludeDefaults(java.lang.String param) {
        localExcludeDefaultsTracker = param != null;

        this.localExcludeDefaults = param;
    }
    ...
    /**
     * Auto generated getter method
     * @return org.apache.maven.pom._4_0_0.Plugins_type2
     */
    public sk.itcloud.maven.pom.form.Plugins_type2 getPlugins() {
        return localPlugins;
    }
     ...
     * @param param Plugins
     */
    public void setPlugins(sk.itcloud.maven.pom.form.Plugins_type2 param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Reporting", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Reporting", xmlWriter);
        ...
        if (localExcludeDefaultsTracker) {
            namespace = "http://maven.apache.org/POM/4.0.0";
            writeStartElement(null, namespace, "excludeDefaults", xmlWriter);

            if (localExcludeDefaults == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "excludeDefaults cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localExcludeDefaults);
            }
    ...
    public static class Factory {
         ...
         */
        public static Reporting parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Reporting object = new Reporting();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Reporting".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Reporting) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "http://maven.apache.org/POM/4.0.0",
                                    "excludeDefaults").equals(reader.getName())) ||
                                new javax.xml.namespace.QName("",
                                    "excludeDefaults").equals(reader.getName())) {
                            ...
                            if ("true".equals(nillableValue) ||
                                ...
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "excludeDefaults" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setExcludeDefaults(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "plugins").equals(
                                    reader.getName())) {
                            object.setPlugins(sk.itcloud.maven.pom.form.Plugins_type2.Factory.parse(
                                    reader));

...
/**
 *  ReportPlugin bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ReportPlugin implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * field for ReportSets
     */
    protected sk.itcloud.maven.pom.form.ReportSets_type0 localReportSets;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localReportSetsTracker = false;
     ...
     */
    protected sk.itcloud.maven.pom.form.Configuration_type4 localConfiguration;
    ...
    public boolean isReportSetsSpecified() {
        return localReportSetsTracker;
    }

    /**
     * Auto generated getter method
     * @return org.apache.maven.pom._4_0_0.ReportSets_type0
     */
    public sk.itcloud.maven.pom.form.ReportSets_type0 getReportSets() {
        return localReportSets;
    }

    /**
     * Auto generated setter method
     * @param param ReportSets
     */
    public void setReportSets(
        sk.itcloud.maven.pom.form.ReportSets_type0 param) {
        localReportSetsTracker = param != null;

        this.localReportSets = param;
    }
    ...
    /**
     * Auto generated getter method
     * @return org.apache.maven.pom._4_0_0.Configuration_type4
     */
    public sk.itcloud.maven.pom.form.Configuration_type4 getConfiguration() {
    ...
    public void setConfiguration(
        sk.itcloud.maven.pom.form.Configuration_type4 param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ReportPlugin", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ReportPlugin", xmlWriter);
            }
        }
        ...
        if (localReportSetsTracker) {
            if (localReportSets == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "reportSets cannot be null!!");
            }

            localReportSets.serialize(new javax.xml.namespace.QName(
                    "http://maven.apache.org/POM/4.0.0", "reportSets"),
                xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static ReportPlugin parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ReportPlugin object = new ReportPlugin();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ReportPlugin".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ReportPlugin) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "http://maven.apache.org/POM/4.0.0",
                                    "reportSets").equals(reader.getName())) ||
                                new javax.xml.namespace.QName("", "reportSets").equals(
                                    reader.getName())) {
                            object.setReportSets(sk.itcloud.maven.pom.form.ReportSets_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("",
                                    "configuration").equals(reader.getName())) {
                            object.setConfiguration(sk.itcloud.maven.pom.form.Configuration_type4.Factory.parse(
                                    reader));

...
public class Dependency implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected sk.itcloud.maven.pom.form.Exclusions_type0 localExclusions;
     ...
     */
    public sk.itcloud.maven.pom.form.Exclusions_type0 getExclusions() {
    ...
    public void setExclusions(
        sk.itcloud.maven.pom.form.Exclusions_type0 param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Dependency".equals(type)) {
                            ...
                            return (Dependency) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "exclusions").equals(
                                    reader.getName())) {
                            object.setExclusions(sk.itcloud.maven.pom.form.Exclusions_type0.Factory.parse(
                                    reader));

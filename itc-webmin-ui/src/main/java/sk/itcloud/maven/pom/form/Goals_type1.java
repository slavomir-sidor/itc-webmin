...
/**
 *  Goals_type1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Goals_type1 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":goals_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "goals_type1", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Goals_type1 parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Goals_type1 object = new Goals_type1();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"goals_type1".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Goals_type1) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

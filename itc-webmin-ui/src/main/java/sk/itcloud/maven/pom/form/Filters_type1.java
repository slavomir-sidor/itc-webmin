...
/**
 *  Filters_type1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Filters_type1 implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected void validateFilter(java.lang.String[] param) {
    }
     ...
     */
    public void addFilter(java.lang.String param) {
        if (localFilter == null) {
            localFilter = new java.lang.String[] {  };
        }
        ...
        list.add(param);
        this.localFilter = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":filters_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "filters_type1", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Filters_type1 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Filters_type1 object = new Filters_type1();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"filters_type1".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Filters_type1) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://maven.apache.org/POM/4.0.0", "filter").equals(
                            reader.getName())) ||
                    ...
                    object.setFilter((java.lang.String[]) list1.toArray(

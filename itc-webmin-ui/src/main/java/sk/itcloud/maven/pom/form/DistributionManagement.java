...
public class DistributionManagement implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected sk.itcloud.maven.pom.form.DeploymentRepository localRepository;
     ...
     */
    protected sk.itcloud.maven.pom.form.DeploymentRepository localSnapshotRepository;
     ...
     * field for Site
     */
    protected sk.itcloud.maven.pom.form.Site localSite;
     ...
     */
    protected sk.itcloud.maven.pom.form.Relocation localRelocation;
     ...
     */
    public sk.itcloud.maven.pom.form.DeploymentRepository getRepository() {
    ...
    public void setRepository(
        sk.itcloud.maven.pom.form.DeploymentRepository param) {
     ...
     * @return org.apache.maven.pom._4_0_0.DeploymentRepository
     */
    public sk.itcloud.maven.pom.form.DeploymentRepository getSnapshotRepository() {
     ...
     */
    public sk.itcloud.maven.pom.form.Site getSite() {
        return localSite;
    }
     ...
     * @param param Site
     */
    public void setSite(sk.itcloud.maven.pom.form.Site param) {
     ...
     */
    public sk.itcloud.maven.pom.form.Relocation getRelocation() {
     ...
     */
    public void setRelocation(sk.itcloud.maven.pom.form.Relocation param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DistributionManagement".equals(type)) {
                            ...
                            return (DistributionManagement) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "repository").equals(
                                    reader.getName())) {
                            object.setRepository(sk.itcloud.maven.pom.form.DeploymentRepository.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("",
                                    "snapshotRepository").equals(
                                    reader.getName())) {
                            object.setSnapshotRepository(sk.itcloud.maven.pom.form.DeploymentRepository.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "site").equals(
                                    reader.getName())) {
                            object.setSite(sk.itcloud.maven.pom.form.Site.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "relocation").equals(
                                    reader.getName())) {
                            object.setRelocation(sk.itcloud.maven.pom.form.Relocation.Factory.parse(
                                    reader));

...
public class BuildBase implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Resources
     */
    protected sk.itcloud.maven.pom.form.Resources_type1 localResources;
     ...
     */
    protected sk.itcloud.maven.pom.form.TestResources_type1 localTestResources;
     ...
     * field for Filters
     */
    protected sk.itcloud.maven.pom.form.Filters_type1 localFilters;
     ...
     * field for Plugins
     */
    protected sk.itcloud.maven.pom.form.Plugins_type3 localPlugins;
     ...
     */
    public sk.itcloud.maven.pom.form.Resources_type1 getResources() {
     ...
     */
    public void setResources(sk.itcloud.maven.pom.form.Resources_type1 param) {
     ...
     */
    public sk.itcloud.maven.pom.form.TestResources_type1 getTestResources() {
    ...
    public void setTestResources(
        sk.itcloud.maven.pom.form.TestResources_type1 param) {
     ...
     */
    public sk.itcloud.maven.pom.form.Filters_type1 getFilters() {
        return localFilters;
    }
     ...
     * @param param Filters
     */
    public void setFilters(sk.itcloud.maven.pom.form.Filters_type1 param) {
     ...
     */
    public sk.itcloud.maven.pom.form.Plugins_type3 getPlugins() {
        return localPlugins;
    }
     ...
     * @param param Plugins
     */
    public void setPlugins(sk.itcloud.maven.pom.form.Plugins_type3 param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"BuildBase".equals(type)) {
                            ...
                            return (BuildBase) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "resources").equals(
                                    reader.getName())) {
                            object.setResources(sk.itcloud.maven.pom.form.Resources_type1.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("",
                                    "testResources").equals(reader.getName())) {
                            object.setTestResources(sk.itcloud.maven.pom.form.TestResources_type1.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "filters").equals(
                                    reader.getName())) {
                            object.setFilters(sk.itcloud.maven.pom.form.Filters_type1.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "plugins").equals(
                                    reader.getName())) {
                            object.setPlugins(sk.itcloud.maven.pom.form.Plugins_type3.Factory.parse(
                                    reader));

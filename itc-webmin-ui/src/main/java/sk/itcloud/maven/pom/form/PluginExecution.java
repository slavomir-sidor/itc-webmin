...
/**
 *  PluginExecution bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class PluginExecution implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Goals
     */
    protected sk.itcloud.maven.pom.form.Goals_type0 localGoals;
     ...
     */
    protected sk.itcloud.maven.pom.form.Configuration_type1 localConfiguration;
     ...
     * @param param Phase
     */
    public void setPhase(java.lang.String param) {
        localPhaseTracker = param != null;
    ...
    /**
     * Auto generated getter method
     * @return org.apache.maven.pom._4_0_0.Goals_type0
     */
    public sk.itcloud.maven.pom.form.Goals_type0 getGoals() {
        return localGoals;
    }
     ...
     * @param param Goals
     */
    public void setGoals(sk.itcloud.maven.pom.form.Goals_type0 param) {
    ...
    /**
     * Auto generated getter method
     * @return org.apache.maven.pom._4_0_0.Configuration_type1
     */
    public sk.itcloud.maven.pom.form.Configuration_type1 getConfiguration() {
    ...
    public void setConfiguration(
        sk.itcloud.maven.pom.form.Configuration_type1 param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":PluginExecution", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "PluginExecution", xmlWriter);
            }
        }
        ...
        if (localPhaseTracker) {
            namespace = "http://maven.apache.org/POM/4.0.0";
            writeStartElement(null, namespace, "phase", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static PluginExecution parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PluginExecution object = new PluginExecution();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PluginExecution".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (PluginExecution) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "http://maven.apache.org/POM/4.0.0", "phase").equals(
                                    reader.getName())) ||
                                new javax.xml.namespace.QName("", "phase").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            object.setPhase(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "goals").equals(
                                    reader.getName())) {
                            object.setGoals(sk.itcloud.maven.pom.form.Goals_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("",
                                    "configuration").equals(reader.getName())) {
                            object.setConfiguration(sk.itcloud.maven.pom.form.Configuration_type1.Factory.parse(
                                    reader));

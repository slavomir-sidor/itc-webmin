...
/**
 *  Configuration_type3 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Configuration_type3 implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = configuration_type3
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":configuration_type3", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "configuration_type3", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Configuration_type3 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Configuration_type3 object = new Configuration_type3();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"configuration_type3".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Configuration_type3) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

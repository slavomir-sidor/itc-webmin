...
/**
 *  ReportSet bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ReportSet implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Reports
     */
    protected sk.itcloud.maven.pom.form.Reports_type1 localReports;
     ...
     */
    protected sk.itcloud.maven.pom.form.Configuration_type3 localConfiguration;
    ...
    /**
     * Auto generated getter method
     * @return org.apache.maven.pom._4_0_0.Reports_type1
     */
    public sk.itcloud.maven.pom.form.Reports_type1 getReports() {
        return localReports;
    }
     ...
     * @param param Reports
     */
    public void setReports(sk.itcloud.maven.pom.form.Reports_type1 param) {
    ...
    /**
     * Auto generated getter method
     * @return org.apache.maven.pom._4_0_0.Configuration_type3
     */
    public sk.itcloud.maven.pom.form.Configuration_type3 getConfiguration() {
    ...
    public void setConfiguration(
        sk.itcloud.maven.pom.form.Configuration_type3 param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ReportSet", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ReportSet", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static ReportSet parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            ReportSet object = new ReportSet();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ReportSet".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ReportSet) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "reports").equals(
                                    reader.getName())) {
                            object.setReports(sk.itcloud.maven.pom.form.Reports_type1.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("",
                                    "configuration").equals(reader.getName())) {
                            object.setConfiguration(sk.itcloud.maven.pom.form.Configuration_type3.Factory.parse(
                                    reader));

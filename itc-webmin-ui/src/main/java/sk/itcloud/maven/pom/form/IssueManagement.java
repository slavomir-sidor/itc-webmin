...
/**
 *  IssueManagement bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class IssueManagement implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":IssueManagement", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "IssueManagement", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static IssueManagement parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            IssueManagement object = new IssueManagement();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"IssueManagement".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (IssueManagement) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

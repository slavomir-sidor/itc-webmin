...
/**
 *  Configuration_type4 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Configuration_type4 implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = configuration_type4
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":configuration_type4", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "configuration_type4", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Configuration_type4 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Configuration_type4 object = new Configuration_type4();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"configuration_type4".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Configuration_type4) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

...
/**
 *  ActivationOS bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ActivationOS implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Arch
     */
    protected java.lang.String localArch;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localArchTracker = false;
    ...
    public boolean isArchSpecified() {
        return localArchTracker;
    }
     ...
     * @param param Arch
     */
    public void setArch(java.lang.String param) {
        localArchTracker = param != null;

        this.localArch = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ActivationOS", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ActivationOS", xmlWriter);
            }
        }
        ...
        if (localArchTracker) {
            namespace = "http://maven.apache.org/POM/4.0.0";
            writeStartElement(null, namespace, "arch", xmlWriter);
            ...
            if (localArch == null) {
                ...
                xmlWriter.writeCharacters(localArch);
            }
    ...
    public static class Factory {
         ...
         */
        public static ActivationOS parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ActivationOS object = new ActivationOS();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ActivationOS".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ActivationOS) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "http://maven.apache.org/POM/4.0.0",
                                    "family").equals(reader.getName())) ||
                                new javax.xml.namespace.QName("", "family").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            object.setFamily(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
                         ...
                         if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "http://maven.apache.org/POM/4.0.0", "arch").equals(
                                    reader.getName())) ||
                                new javax.xml.namespace.QName("", "arch").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            object.setArch(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));

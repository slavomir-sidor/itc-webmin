...
/**
 *  Configuration_type1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Configuration_type1 implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = configuration_type1
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":configuration_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "configuration_type1", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Configuration_type1 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Configuration_type1 object = new Configuration_type1();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"configuration_type1".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Configuration_type1) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

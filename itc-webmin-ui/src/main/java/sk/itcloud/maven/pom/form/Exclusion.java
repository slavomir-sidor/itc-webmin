...
/**
 *  Exclusion bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Exclusion implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static Exclusion parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Exclusion".equals(type)) {
                            ...
                            return (Exclusion) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

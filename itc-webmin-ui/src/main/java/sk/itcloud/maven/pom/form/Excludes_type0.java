...
/**
 *  Excludes_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Excludes_type0 implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected void validateExclude(java.lang.String[] param) {
    }
     ...
     */
    public void addExclude(java.lang.String param) {
        if (localExclude == null) {
            localExclude = new java.lang.String[] {  };
        }
        ...
        list.add(param);
        this.localExclude = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":excludes_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "excludes_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Excludes_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Excludes_type0 object = new Excludes_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"excludes_type0".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Excludes_type0) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://maven.apache.org/POM/4.0.0", "exclude").equals(
                            reader.getName())) ||
                    ...
                    object.setExclude((java.lang.String[]) list1.toArray(

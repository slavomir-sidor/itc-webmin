...
/**
 *  Reports_type2 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Reports_type2 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":reports_type2", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "reports_type2", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Reports_type2 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Reports_type2 object = new Reports_type2();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"reports_type2".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Reports_type2) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

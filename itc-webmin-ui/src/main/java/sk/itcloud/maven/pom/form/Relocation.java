...
/**
 *  Relocation bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Relocation implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Relocation", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Relocation", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Relocation parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Relocation object = new Relocation();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Relocation".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Relocation) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }

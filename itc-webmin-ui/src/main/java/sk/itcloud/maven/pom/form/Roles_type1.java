...
/**
 *  Roles_type1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Roles_type1 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":roles_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "roles_type1", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Roles_type1 parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Roles_type1 object = new Roles_type1();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"roles_type1".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Roles_type1) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://maven.apache.org/POM/4.0.0", "role").equals(
                            reader.getName())) ||
                    ...
                    object.setRole((java.lang.String[]) list1.toArray(

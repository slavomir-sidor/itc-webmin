...
/**
 *  ActivationProperty bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ActivationProperty implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ActivationProperty", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ActivationProperty", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ActivationProperty parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ActivationProperty object = new ActivationProperty();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ActivationProperty".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ActivationProperty) sk.itcloud.maven.pom.form.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                         ...
                         if ((reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "http://maven.apache.org/POM/4.0.0", "value").equals(
                                    reader.getName())) ||

...
- itc-webmin-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- itc-webmin-ui: main application module, development time
- itc-webmin-production: module that produces a production mode WAR for deployment
